...
- Present DSH inside the desktop window without a second system-browser window; older runtimes that do not support browser suppression use the compatibility launch path.
